...
function orderbook_hitbtc_com($exchange,$symbol,$symbol_orig,$marketid,$quotecurrency,$basecurrency,$state,$date,$wertinusd,$PWD1)
{
$orderbook=array();
...
$response_buy=$response["bid"];
$response_sell=$response["ask"];
