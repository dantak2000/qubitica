...
function orderbook_lbank_info($exchange,$symbol,$symbol_orig,$marketid,$quotecurrency,$basecurrency,$state,$date,$wertinusd,$PWD1)
{
$orderbook=array();
...
$url="https://api.lbkex.com/v1/depth.do?symbol=$symbol_orig&size=60&merge=0";
