...
function orderbook_okex_com($exchange,$symbol,$marketid,$quotecurrency,$basecurrency,$state,$date,$wertinusd,$PWD1)
{
$orderbook=array();
...
$parsestring = file_get_contents("https://www.okex.com/api/v1/depth.do?symbol=$symbol");
